        ...
        try {
          ...
          if (subtypes && subtypes.length > 0) {
            ...
            if (validSubtypes.length > 0) {
              ...
              toast.warning(
                "No subtypes available for this document type on the selected date",
                {
                  description:
          ...
          if (
            ...
            onSubTypeChange("");
            toast.info("Selected subtype is not valid for the chosen date", {
              description:
                "Your selection has been reset. Please choose from available subtypes.",
              duration: 3000,
            });
          }
        } catch (error) {
          ...
          toast.error("Failed to load subtypes", {
            description:
              "There was a problem loading subtypes for the selected document type and date.",
            duration: 4000,
          });

          // Try to get all subtypes as fallback
          try {
            const allSubtypes = await subTypeService.getSubTypesByDocType(
              selectedTypeId
            );
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mt-1">
                Showing document types and subtypes valid for:{" "}
      ...
      <div className="space-y-3">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        toast.info("Please select a different date", {
                          description:
                            "Try choosing another date that has valid document types and subtypes.",
                          duration: 3000,
                        });
                      }}
                    >
        ...
        <p className="text-sm text-gray-400">
          Only showing document types with valid subtypes for the selected date
        </p>
      </div>
        ...
        <div className="space-y-3 mt-4 pt-4 border-t border-gray-800/50">
          ...
          {isLoadingSubTypes ? (
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 text-sm text-blue-400">
                <Loader2 className="h-4 w-4 animate-spin" />
                <span>Loading subtypes for selected document type...</span>
              </div>
            </div>
          ) : noSubTypesAvailable ? (
            <Card className="bg-amber-900/20 border-amber-800/40">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          toast.info(
                            ...
                            {
                              description:
                                "Try choosing another document type that has valid subtypes.",
                              duration: 3000,
                            }
                          );
                        }}
            ...
            <>
              ...
              <div className="relative" ref={subtypeDropdownRef}>
                ...
                >
                  ...
                  >
                    {selectedSubType ? selectedSubType.name : "Select subtype"}
                  </span>
                  <ChevronDown
                    className={`h-4 w-4 text-gray-400 transition-transform duration-200 ${
          ...
          <p className="text-sm text-gray-400">
            Only showing subtypes valid for the selected date
          </p>
        </div>
      )}

      {/* Show selected subtype details */}
      {selectedSubType && (
